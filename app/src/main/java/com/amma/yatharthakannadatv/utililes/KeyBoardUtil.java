...
public class KeyBoardUtil {
     ...
     */
    private static void showKeyboard(@Nullable Activity activity) {
    ...
    /**
     * To check visibility of software keyboard in Android
     */
    public static void addKeyboardVisibilityChangedListener(
            @NonNull final OnKeyboardVisibilityChangedListener listener, @NonNull Activity activity) {
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                float estimatedKeyboardHeight = DeviceUtil.dpToPx(ESTIMATED_KEYBOARD_SIZE_DP);
    ...
    /**
     * Hides keyboard in the current activity
     */
